      ...
      <Menu setActive={setActive}>
        ...
        <div className={`hidden lg:flex space-x-4 text-sm`}>
          ...
          <NavLink
            to="./service"
            onClick={(event) => {
                handleHeaderClick(event); // Existing click functionality
          ...
          <NavLink
            ...
            onMouseEnter={() => handleHeaderHover("portfolio")} // Existing hover functionality
            style={{ textDecoration: "none" }}
          >
        ...
        >
          <div className="flex flex-col space-y-3 p-3">
            {/* Repeat the Menu Items here for smaller screens */}
            <NavLink to="./home" onClick={handleHeaderClick}>
              Home
            </NavLink>
            <NavLink to="./service" onClick={handleHeaderClick}>
              Services
            </NavLink>
            <NavLink to="./portfolio" onClick={handleHeaderClick}>
              Portfolio
            </NavLink>
            <NavLink to="./casestudy" onClick={handleHeaderClick}>
              Case Study
            </NavLink>
            <NavLink to="./pricing" onClick={handleHeaderClick}>
              Pricing
            </NavLink>
            <NavLink to="./contact" onClick={handleHeaderClick}>
              Contact Us
            </NavLink>
            <NavLink to="./aboutus" onClick={handleHeaderClick}>
              About Us
            </NavLink>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          {searchVisible && (
            <div className="absolute top-full mt-2 w-80 bg-white p-2 rounded-lg shadow-md">
